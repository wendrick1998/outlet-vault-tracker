-- CORREÇÃO: Etiquetas automáticas sem foreign key violation
-- Executar função detect_demonstration_items 
SELECT public.detect_demonstration_items();

-- Criar trigger automático para aplicar etiqueta "Demonstração"
...
-- Criar função para etiqueta "Empréstimo" 
...
-- Aplicar etiquetas para itens existentes na vitrine (sem applied_by para evitar FK violation)
INSERT INTO public.stock_item_labels (stock_item_id, label_id)
SELECT 
    si.id,
    l.id
