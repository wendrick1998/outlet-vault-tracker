-- Phase F3: Structured Reasons System
...
CREATE TABLE public.reason_workflows (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    reason_id UUID NOT NULL REFERENCES public.reasons(id) ON DELETE CASCADE,
    step_order INTEGER NOT NULL,
    step_name TEXT NOT NULL,
    step_type TEXT NOT NULL, -- approval, notification, auto_action
...
-- Insert sample workflow for high-priority reasons
