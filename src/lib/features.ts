...
const DEFAULT_FEATURES: Record<FeatureFlag, boolean> = {
  ...
  [FEATURE_FLAGS.ADVANCED_INVENTORY_SEARCH]: false,
  [FEATURE_FLAGS.BATCH_OPERATIONS]: false,
  [FEATURE_FLAGS.INVENTORY_CATEGORIES]: false,
  [FEATURE_FLAGS.GRANULAR_PERMISSIONS]: false,
  [FEATURE_FLAGS.ROLE_BASED_VISIBILITY]: false,
  [FEATURE_FLAGS.REASON_CATEGORIES]: false,
  [FEATURE_FLAGS.REASON_WORKFLOWS]: false,
  [FEATURE_FLAGS.SLA_TRACKING]: false,
  [FEATURE_FLAGS.REAL_TIME_SYNC]: false,
  [FEATURE_FLAGS.OFFLINE_QUEUE]: false,
